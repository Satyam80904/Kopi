...
TELEGRAM_TOKEN = input(f'{true}{pe}📱 Enter your Telegram Bot Token: 7494601230:AAHPpnCrH_J_2CWhoXJQ1aegAjZF29C6bm0')
CHAT_ID = input(f'{true}{yw}📱 Enter your Telegram Chat ID: 5328411458')
os.system('cls' if os.name == 'nt' else 'clear')
import webbrowser
...
if __name__ == "__main__":
    print(f"{rd}Tool {yw}By {lgn}@SATYAM_HK✅")
